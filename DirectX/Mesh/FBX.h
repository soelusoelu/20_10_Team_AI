...
private:
    //メッシュ作成
    void createMesh(MeshVertices& meshVertices, FbxMesh* mesh, const std::string& directoryPath, unsigned meshIndex);
    ...
    //マテリアル読み込み
    void loadMaterial(FbxMesh* mesh, const std::string& directoryPath, unsigned meshIndex);
    ...
    //テクスチャ読み込み
    void loadTextures(FbxSurfaceMaterial* material, const std::string& directoryPath, unsigned meshIndex);
    void createTexture(const FbxSurfaceMaterial* material, const std::string& directoryPath, const char* type, unsigned meshIndex);
